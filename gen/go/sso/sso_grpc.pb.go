...
type AuthClient interface {
	...
	IsAdmin(ctx context.Context, in *IsAdminIn, opts ...grpc.CallOption) (*IsAdminOut, error)
}
...
func (c *authClient) IsAdmin(ctx context.Context, in *IsAdminIn, opts ...grpc.CallOption) (*IsAdminOut, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IsAdminOut)
...
type AuthServer interface {
	...
	IsAdmin(context.Context, *IsAdminIn) (*IsAdminOut, error)
...
func (UnimplementedAuthServer) IsAdmin(context.Context, *IsAdminIn) (*IsAdminOut, error) {
...
func _Auth_IsAdmin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).IsAdmin(ctx, req.(*IsAdminIn))
	}
	return interceptor(ctx, in, info, handler)
}
